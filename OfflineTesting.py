...
###########################_____________FEATURE FUNCTIONS____________#################################################
...
test_file=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Test\blink\bilal husssain-blink10-16.01.20.00.36.43.csv"

dflist=[]
df = pd.read_csv(test_file,sep=',', header=1)
...
dflist.append(df)
data=pd.concat(dflist,axis=1,ignore_index = True)
