...
##########################################################################
#for concatenating Action files
dflist=[]
indir=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Concat\First"
os.chdir(indir)
...
outfile=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Tests\Stage-1\Labelled Files\First.csv"
concatdf=pd.concat(dflist,axis=0,ignore_index = True)       #axis=0 for row addition
concatdf['Class'] = 1
concatdf.to_csv(outfile,index=None)


#for concatenating Med files
dflist=[]
indir=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Concat\Second"
os.chdir(indir)
filelist=glob.glob("*.csv")
...
outfile=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Tests\Stage-1\Labelled Files\Second.csv"
concatdf=pd.concat(dflist,axis=0,ignore_index = True)       #axis=0 for row addition
concatdf.to_csv(outfile,index=None)

##########################################################################
#for concatenating all the files
indir=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Tests\Stage-1\Labelled Files"
outfile=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Tests\Stage-1\Stage-1_Complete.csv"
os.chdir(indir)
filelist=glob.glob("*.csv")
dflist=[]
for filename in filelist:
...
file=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Tests\Stage-1\Stage-1_Complete.csv"
outfile=r"C:\Users\Bilal\Desktop\Multi-Commands\Bilal's Data (Only)\Command-6\Path-1\Tests\Stage-1\Stage-1_Train.csv"
